...
public class Ex05_03 {
	...
	public static void main(String[] args) {
		...
		list.add(new Person3("박성호",23));
		list.add(new Person3("김성준",21));
		list.add(new Person3("주강민",21));
		list.add(new Person3("이경서",20));
		list.add(new Person3("이준희",20));
		list.add(new Person3("신기범",30));

		System.out.println(list);   //[Person3 [name=박성호, age=23], Person3 [name=김성준, age=21]........
