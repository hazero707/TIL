...
public class Ex06 {
	...
	public static void main(String[] args) {
		 ...
		 *  해시 테이블(hash table)에 저장하고 검색하는 기법 
		 *  - 해시함수 ? 데이터가 저장되어 있는 곳을 알려 주는 함수 .
		 *  데이터를 빠르게 찾을 수 있다. 
		 *  -데이터 저장 ( key+ value) 키를 해시 함수에 넣으면 
		 *  배열의 한 요소를 얻어오고 
		...
		//HashMap  동기화 처리 x  ArrayList
		Hashtable<String, String> hm = new Hashtable<>();    // HashMap 대신 Hashtable 사용해도됨, HashMap 추천 
		//Hashtable 동기화 처리 o  Vector
		...
		//ture/ false hm.containsValue("홍중복");
	...
	//private static void dispHm(HashMap<String, String> hm) {
		private static void dispHm(Hashtable<String, String> hm) {
			...
			Set<Entry<String, String>> eset = hm.entrySet();  //한쌍을 저장하고 있는 
